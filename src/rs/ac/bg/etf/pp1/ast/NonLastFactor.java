...
public class NonLastFactor extends MultipleFactorList {

    private MultipleFactorList MultipleFactorList;
    private MulOp MulOp;
    private Factor Factor;

    public NonLastFactor (MultipleFactorList MultipleFactorList, MulOp MulOp, Factor Factor) {
